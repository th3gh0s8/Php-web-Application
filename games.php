...
<html>
    ...
    <body class="" style=" background-image: url('pics/pics1.jpg');height: auto; width: 100%; background-size: cover">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7));">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" method="get" action="games.php">
        ...
        <div class="container-fluid row row-col-12 row-col-sm-6 row-col-md-4 row-col-lg-2">
            ...
            $query = "SELECT * FROM product WHERE name  LIKE '%" . $keywords . "%' AND cat LIKE '%" . $game . "%' ";
